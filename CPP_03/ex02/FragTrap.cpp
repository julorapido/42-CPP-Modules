...
/*   Updated: 2025/02/17 14:15:37 by jsaintho         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(): ClapTrap("FR4G-TRAP")
{
	...
	this->_attack_dmg = 30;
	std::cout << "+1 FragTrap Default Constructor called" << std::endl;
}
...
FragTrap::FragTrap(std::string name): ClapTrap(name)
{
	...
	this->_energy_pts = 100;
	this->_attack_dmg = 30;
	std::cout << "\033[34m +1 FragTrap :'" << this->_name << "' appeared.\033[0m" << std::endl;
}
